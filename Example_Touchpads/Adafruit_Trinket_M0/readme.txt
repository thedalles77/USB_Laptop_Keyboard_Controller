...
Trinket_M0_TP.ino is for a Samsung Galaxybook Flex touchpad part number BA61-04080A. This touchpad uses I2C for communication with an INTN signal that goes low when there is data available. See the file Hookup_schematic.jpg to see how it was wired to an FPC breakout board.
