...
*/
// This software creates a USB keyboard from a Toshiba 2415 keyboard using a Teensy 4.1
//
// Revision History
...
//
// Assign the Teensy 4.1 I/O row numbers
int Row_IO[rows_max] = {20,3,18,5,16,7,9,27,11,24,25,26,27,28,29,30}; 

// Assign the column I/O numbers
int Col_IO[cols_max] = {19,4,17,6,15,8,14,12}; 
