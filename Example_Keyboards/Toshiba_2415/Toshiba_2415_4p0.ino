...
*/
// This software creates a USB keyboard from a Toshiba 2415 keyboard using a Teensy 4.0
//
// Revision History
...
int Row_IO[rows_max] = {20,3,18,5,29,7,9,32,10,11,28,12,27,26,25,24}; 

// Assign the column I/O numbers
int Col_IO[cols_max] = {19,4,17,6,31,8,33,30}; 
