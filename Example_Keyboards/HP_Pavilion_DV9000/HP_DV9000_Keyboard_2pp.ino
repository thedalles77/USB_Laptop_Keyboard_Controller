...
*/
// This software implements an HP Pavilion DV9000 Laptop Keyboard Controller using a Teensy 2++ on 
...
// 
// Revision History
// Initial Release Dec 17, 2023   (based on the LC code)
//
...
unsigned int Row_IO[rows_max] = {27,26,0,25,2,24,2,23,3,22,4,21,5,20,19,7,9,39}; 

unsigned int Col_IO[cols_max] = {28,18,8,38,10,11,40,12};                       
