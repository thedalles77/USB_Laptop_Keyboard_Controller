...
*/
// This software implements an HP Pavilion DV9000 Laptop Keyboard Controller using a Teensy 4.0 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,4,18,5,17,6,7,31,9,30}; 
                        
int Col_IO[cols_max] = {29,8,33,32,10,11,28,12};                       
