...
*/
// This software controls a Lenovo ThinkPad T61 Laptop Keyboard, PS/2 Trackpoint and PS/2 Touchpad
...
// Touchpad signals
#define TOUCH_DATA 11  // ps/2 data to touchpad (level translated)
#define TOUCH_CLK 12   // ps/2 clock to touchpad (level translated)
// Keyboard LEDs
