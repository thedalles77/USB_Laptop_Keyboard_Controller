...
*/
// This software implements a Dell Latitude 131L Laptop Keyboard Controller using a Teensy 2.0++ on 
...
// 
// Revision History
// Initial Release Dec 11, 2023       Based on the original Teensy LC version
// 
//
...
// 
// 
unsigned int Row_IO[rows_max] = {27,26,0,25,1,24,2,23,3,22,4,21,5,20,28,19,7}; // Teensy 2.0++ I/O numbers for rows
//                      
// 
// 
unsigned int Col_IO[cols_max] = {18,8,9,38,10,39,11,40};                       // Teensy 2.0++ I/O numbers for columns
//                      
