...
*/
// This software implements a Dell Latitude 131L Laptop Keyboard Controller using a Teensy 4.0 on 
...
// 
// 
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,4,18,5,17,6,29,7,31}; // Teensy 4.0 I/O numbers for rows
//                      
// 
// 
int Col_IO[cols_max] = {8,33,9,32,10,30,11,28};                       // Teensy 4.0 I/O numbers for columns
//                      
