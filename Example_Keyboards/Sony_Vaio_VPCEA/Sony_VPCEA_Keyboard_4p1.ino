...
*/
// This software implements a Sony Vaio VPCEA Laptop Keyboard Controller using a Teensy 4.1 on 
...
int Row_IO[rows_max] = {0,22,1,21,2,3,18,17,6,16,7,15,8,9,10,11}; 

int Col_IO[cols_max] = {20,19,4,5,14,12,24,25};  
