...
*/
// This software implements a Sony Vaio VPCEA Laptop Keyboard Controller using a Teensy 2.0++ on 
...
// 
// Revision History
// Initial Release Dec 17, 2023  (translated from the 3.2 code)
//
...
unsigned int Row_IO[rows_max] = {26,0,25,1,24,23,4,5,20,28,19,7,18,9,38,10}; 

unsigned int Col_IO[cols_max] = {2,3,22,21,8,39,11,40};  
