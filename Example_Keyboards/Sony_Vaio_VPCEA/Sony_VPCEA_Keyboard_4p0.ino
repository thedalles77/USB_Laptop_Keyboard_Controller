...
*/
// This software implements a Sony Vaio VPCEA Laptop Keyboard Controller using a Teensy 4.0 on 
...
int Row_IO[rows_max] = {0,22,1,21,2,3,18,17,6,29,7,31,8,9,32,10}; 

int Col_IO[cols_max] = {20,19,4,5,33,30,11,28};  
