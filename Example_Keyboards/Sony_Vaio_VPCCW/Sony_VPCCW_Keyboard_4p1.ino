...
*/
// This software implements an Sony Vaio VPCCW Laptop Keyboard Controller using a Teensy 4.1 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,20,4,5,17,6,16,7,15,14,9,10}; 

int Col_IO[cols_max] = {2,3,19,18,8,11,12,24};                       
