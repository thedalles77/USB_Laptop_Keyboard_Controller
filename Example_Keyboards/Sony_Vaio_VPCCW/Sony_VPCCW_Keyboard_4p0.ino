...
*/
// This software implements an Sony Vaio VPCCW Laptop Keyboard Controller using a Teensy 4.0 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,20,4,5,17,6,29,7,31,33,9,32}; 

int Col_IO[cols_max] = {2,3,19,18,8,10,30,11};                       
