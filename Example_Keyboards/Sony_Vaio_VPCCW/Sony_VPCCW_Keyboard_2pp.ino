...
*/
// This software implements an Sony Vaio VPCCW Laptop Keyboard Controller using a Teensy 2.0++ on 
...
// 
// Revision History
// Initial Release Dec 17, 2023   (translated from the LC code)
//
...
//
// Define the Teensy I/O numbers (translated from the FPC pin #)

unsigned int Row_IO[rows_max] = {27,26,0,25,1,2,22,21,5,20,28,19,7,8,9,38}; 
                        
unsigned int Col_IO[cols_max] = {24,23,3,4,18,10,39,11};                       
