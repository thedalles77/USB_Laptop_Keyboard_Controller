...
*/
// This software implements a Sony Vaio PCG-K25 Laptop Keyboard Controller using a Teensy ++2.0 on 
// a daughterboard with an FPC connector. 
...
// 
// Revision History
// Initial Release May 31, 2021
//
#define MODIFIERKEY_FN 0x8f   // give Fn key a HID code 
#define CAPS_LED PIN_D6 // Teensy LED shows Caps-Lock
//
...
// Row FPC pin # put a list of the row pins here
// Teensy I/O  # put a list of Teensy I/O's here in the same order, then put them below
int Row_IO[rows_max] = {PIN_E0,PIN_E1,PIN_F0,PIN_C0,PIN_F1,PIN_C1,PIN_F2,PIN_C2,PIN_F3,PIN_C3,PIN_F4,PIN_C4,PIN_F5,PIN_C5,PIN_F6,PIN_C6};
//
// Column FPC pin # put a list of the column pins here
// Teensy I/O     # put a list of Teensy I/O's here in the same order, then put them below
int Col_IO[cols_max] = {PIN_B7,PIN_B6,PIN_D0,PIN_B5,PIN_D1,PIN_B4,PIN_D2,PIN_B3};
