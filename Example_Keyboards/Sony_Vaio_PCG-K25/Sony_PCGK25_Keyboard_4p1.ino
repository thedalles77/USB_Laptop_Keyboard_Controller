...
*/
// This software implements a Sony Vaio PCG-K25 Laptop Keyboard Controller using a Teensy 4.1 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,3,19,4,16,7,14,9,10,11,12,24}; 

int Col_IO[cols_max] = {2,20,18,5,17,6,15,8};                       
