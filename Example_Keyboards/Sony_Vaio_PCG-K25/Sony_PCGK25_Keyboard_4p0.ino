...
*/
// This software implements a Sony Vaio PCG-K25 Laptop Keyboard Controller using a Teensy 4.0 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,3,19,4,29,7,33,9,32,10,30,11}; 
//
int Col_IO[cols_max] = {2,20,18,5,17,6,31,8};                       
//
