...
*/
// This software implements a Sony Vaio VPCEB4 Laptop Keyboard Controller using a Teensy 2++ on 
...
unsigned int Row_IO[rows_max] = {26,0,25,1,24,23,4,5,20,28,19,7,18,9,38,10,12,41}; 
//                      
