...
*/
// It will determine how a laptop keyboard matrix is wired using a Teensy LC on a Zenith Supersport FPC daughterboard .
...
int con_pin[] = {12, 11, 10, 15, 9, 8, 7, 18, 6, 19, 20, 4, 25, 3, 2, 1, 22, 0}; 
//
// Define maximum and minimum pin numbers that will be tested. 
//
int max_pin = 18; // the last pin to be tested on the FPC connector
int min_pin = 1; // the first pin to be tested on the FPC connector
//
