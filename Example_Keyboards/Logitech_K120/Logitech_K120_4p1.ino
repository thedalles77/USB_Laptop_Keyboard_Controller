...
*/
// This software implements a Logitech K120 Keyboard Controller using a Teensy 4.1 wired to a 
// pcb with pads. The flexible sheets with traces in the keyboard are pressed against the pcb pads 
// to make connection. No FPC connector is used.
// Revision History
// Initial Release Nov 22, 2021 
//
...
//
// Function to set a pin as an input without a pullup
void go_z(int pin)
{
  pinMode(pin, INPUT);
}
