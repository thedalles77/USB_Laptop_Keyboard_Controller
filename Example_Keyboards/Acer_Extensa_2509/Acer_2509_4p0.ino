...
*/
// This software implements an Acer Extensa 2509 Laptop Keyboard Controller using a Teensy 4.0 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,4,18,5,17,6,29,7,31,8}; 
//                      
int Col_IO[cols_max] = {33,9,32,10,30,11,28,12};                       
//                      
