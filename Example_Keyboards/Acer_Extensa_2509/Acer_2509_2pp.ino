...
*/
// This software implements an Acer Extensa 2509 Laptop Keyboard Controller using a Teensy 2.0++ on 
...
//
// Define the Teensy 2.0++ I/O numbers (translated from the FPC pin #)

unsigned int Row_IO[rows_max] = {27,26,0,25,1,24,2,23,3,22,4,21,5,20,28,19,7,18}; 
//                      
unsigned int Col_IO[cols_max] = {8,9,38,10,39,11,40,12};                       
//                      
