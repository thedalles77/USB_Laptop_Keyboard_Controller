...
*/
// This software implements a Dell Inspiron 1525 Laptop Keyboard Controller using a Teensy 4.0 on 
...
// 
// 
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,4,18,5,17,6,29,7,31}; // Teensy 4.0 I/O’s for rows
//
// 
// 
