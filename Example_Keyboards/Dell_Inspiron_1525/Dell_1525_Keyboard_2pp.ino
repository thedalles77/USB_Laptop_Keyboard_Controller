...
*/
// This software implements a Dell Inspiron 1525 Laptop Keyboard Controller using a Teensy 2.0++ on 
...
#define CAPS_LED 6 // Teensy LED shows Caps-Lock
//
...
// 
// 
unsigned int Row_IO[rows_max] = {27,26,0,25,1,24,2,23,3,22,4,21,5,20,28,19,7}; // Teensy 2.0++ rows
//
// 
// 
