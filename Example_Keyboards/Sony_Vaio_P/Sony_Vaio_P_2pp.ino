...
*/
// This software implements a Sony Vaio P Laptop USB Keyboard Controller using a Teensy 2.0++
//
// Revision History
// Initial Release Dec 18, 2023   (translated from the LC code)
//
...
unsigned int Row_IO[rows_max] = {27,26,0,25,1,24,2,23,3,18,8,9,38,10,39,11}; 
//                      
unsigned int Col_IO[cols_max] = {22,4,21,5,20,28,19,7};                       
//                      
