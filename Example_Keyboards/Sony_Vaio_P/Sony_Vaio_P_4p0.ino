...
*/
// This software implements a Sony Vaio P Laptop USB Keyboard Controller using a Teensy 4.0 
//
// Revision History
...
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,8,33,9,32,10,30,11}; 
//                      
int Col_IO[cols_max] = {4,18,5,17,6,29,7,31};                       
//                      
