...
*/
// This software implements a Dell Latitude X1 Laptop Keyboard Controller using a Teensy 4.1 on 
...
// 
int Row_IO[rows_max] = {19,4,18,5,17,6,16,7,15,8,14,9,10,11,12,24}; 
//
int Col_IO[cols_max] = {23,0,22,1,21,2,18,3};                       
//
