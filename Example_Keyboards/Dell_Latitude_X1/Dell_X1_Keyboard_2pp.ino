...
*/
// This software implements a Dell Latitude X1 Laptop Keyboard Controller using a Teensy 2.0++ on 
...
// 
// Revision History
// Initial Release Dec 14, 2023   Translated from LC
// 
//
...
// 
unsigned int Row_IO[rows_max] = {3,22,4,21,5,20,28,19,7,18,8,9,38,10,39,11}; 
//
unsigned int Col_IO[cols_max] = {27,26,0,25,1,24,2,23};                       
//
