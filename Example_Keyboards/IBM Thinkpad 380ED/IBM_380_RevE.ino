...
// Rev E June 28, 2026 - Fixed right brace in matrix. Moved Caps lock to onboard LED
#define MODIFIERKEY_FN 0x8f   // give Fn key a fake HID code 
#define CAPS_LED 13 // The LED on the Teensy will be "On" when Caps Lock is engaged
#define NUM_LED 15 // Teensy I/O 15 connected to thru hole pad with resistors for LED
#define SCRL_LED 16 // Teensy I/O 15 connected to thru hole pad with resistors for LED
...
int normal[rows_max][cols_max] = {
  ...
  {KEY_F6,KEY_RIGHT_BRACE,KEY_EQUAL,KEY_8,0,0,KEY_COMMA,KEY_K,KEY_I},
...
int numlock[rows_max][cols_max] = {
  ...
  {KEY_F6,KEY_RIGHT_BRACE,KEY_EQUAL,KEYPAD_8,0,0,KEY_COMMA,KEYPAD_2,KEYPAD_5},
  {KEY_UP,0,KEY_HOME,KEY_END,KEY_LEFT,0,KEY_PAUSE,0,0},
...
//
  if (keyboard_leds & 1<<1) {  // mask off all bits but D1 and test if set
    go_1(CAPS_LED); // turn on the LED on the Teensy
  }
  else {
    go_0(CAPS_LED); // turn off the Teensy LED
  }
//
