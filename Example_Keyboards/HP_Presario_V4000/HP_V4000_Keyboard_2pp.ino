...
*/
// This software implements an HP Compaq Presario V4000 Laptop Keyboard Controller using a Teensy 2.0++ on 
...
// 
// Revision History
// Initial Release Dec 16, 2023   (modified from LC code)
//
