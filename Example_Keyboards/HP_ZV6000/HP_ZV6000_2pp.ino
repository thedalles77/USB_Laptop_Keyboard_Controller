...
*/
// This software implements a HP ZV6000 Laptop Keyboard Controller using a Teensy 2++ on 
// a daughterboard with a 24 pin FPC connector. The keyboard has an Italian layout.
// You must select Keyboard Layout: "Italian" to avoid compilation errors.
...
// 
// Revision History
// Original Release Dec 17, 2023  (translated from the LC code)
//
...
//
// Define the Teensy 2++ I/O numbers (translated from the FPC pin #)
//
unsigned int Row_IO[rows_max] = {25,2,22,4,5,20,28,19,7,18,8,9,38,10,39,11}; 

unsigned int Col_IO[cols_max] = {27,26,0,1,24,23,3,21}; 
