...
*/
// This software implements an HP Compaq Presario 2100 Laptop Keyboard Controller using a Teensy 4.1 on 
...
int Row_IO[rows_max] = {23,0,22,1,21,2,20,3,19,4,18,5,17,6,16,7,15}; 
//
int Col_IO[cols_max] = {8,14,9,10,11,12,24,25};                       
//
