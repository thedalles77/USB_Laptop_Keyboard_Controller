...
*/
// This software implements a Toshiba T1200 Laptop Keyboard Controller using a Teensy LC on 
// a special daughterboard with a 22 pin FPC connector. The Teensy I/O to FPC translation is the same as my regular connector board.
...
int modifier[rows_max][cols_max] = {
  ...
  {MODIFIERKEY_GUI,MODIFIERKEY_FN,0,0,0,0,0,0}   // there is no Windows GUI key so I used the System Request key
};
...
// 
int Row_IO[rows_max] = {23,0,22,24,2,21,3,4,20,5,19};
//
int Col_IO[cols_max] = {6,18,7,17,16,9,15,10};                       
